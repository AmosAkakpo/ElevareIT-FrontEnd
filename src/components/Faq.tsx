...
export function Faq() {
  ...
  const faqs = {
    ...
    fr: [
      ...
      {
        question: "Pourrai-je voir l'avancement du site web pendant son développement ?",
        answer:
      ...
      },
      {
        ...
        answer:
          "Absolument. Nous réalisons des designs UI/UX, des affiches, des annonces et d'autres supports visuels en cohérence avec l'identité de votre marque.",
      },
    ],
  };
            ...
            return (
              <div
                ...
                className={`rounded-xl border transition-colors duration-300 overflow-hidden ${
                  isOpen ? 'border-tealCustom bg-white shadow-md' : 'border-gray-300 bg-gray-200 shadow-sm'
                }`}
              >
                <button
                ...
                >
                  ...
                  <ChevronDown
                    className={`flex-shrink-0 text-tealCustom transition-transform duration-300 ${
