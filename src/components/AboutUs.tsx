...
const highlights = [
  ...
  },
  {
    ...
    descEn: "Delivering high-quality work is our priority, ensuring every project exceeds expectations.",
    descFr: "Livrer un travail de haute qualité est notre priorité, chaque projet dépassant les attentes.",
  },
  {
    src: gearanimation,
    titleEn: "Experienced",
    titleFr: "Expérience",
    descEn: "We have experience with a variety of digital tools to provide solutions tailored to our clients.",
    descFr: "Nous avons de l'expérience avec divers outils numériques pour fournir des solutions adaptées à nos clients.",
  },
];

// Defined outside AboutUs to prevent re-creation on every render
function HighlightCard({
  ...
  return (
    <div
      ref={ref}
      className="bg-gray-200 p-6 rounded-xl shadow-md text-center w-64 hover:shadow-lg transition-shadow duration-300"
    >
      ...
      <p className="text-gray-600 text-sm">{language === "en" ? descEn : descFr}</p>
    </div>
  );
}
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            {language === "en"
              ? "We are a small, hard-working, and passionate team. With experience in a wide range of tools, we create digital solutions designed to satisfy and delight our clients."
